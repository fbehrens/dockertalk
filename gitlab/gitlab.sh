...
echo "deb http://de.archive.ubuntu.com/ubuntu/ precise universe" >> /etc/sources.list
...
apt-get install -y vim    sudo update-alternatives --set editor /usr/bin/vim.basic
